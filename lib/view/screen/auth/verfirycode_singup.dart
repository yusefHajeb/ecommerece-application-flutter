...
class VerfiryCodeSingeUp extends StatelessWidget {
  const VerfiryCodeSingeUp({super.key});

  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    VerifictionSingeUpControllerImp controller =
        Get.put(VerifictionSingeUpControllerImp());
    return Scaffold(
      // appBar: AppBar(),
      body: WillPopScope(
        onWillPop: () {
